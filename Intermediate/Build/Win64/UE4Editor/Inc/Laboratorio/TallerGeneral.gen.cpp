...
// End Cross Module References
	...
	{
		P_GET_PROPERTY(FStrProperty,Z_Param_NaveaFabricar);
		P_GET_OBJECT(UWorld,Z_Param_World);
		P_GET_STRUCT(FVector,Z_Param_SpawnLocation);
		P_GET_STRUCT(FRotator,Z_Param_SpawnRotation);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(ANaveEnemiga**)Z_Param__Result=ATallerGeneral::FabricarNave(Z_Param_NaveaFabricar,Z_Param_World,Z_Param_SpawnLocation,Z_Param_SpawnRotation);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_ATallerGeneral_FabricarNave_Statics
	{
		...
		{
			FString NaveaFabricar;
			UWorld* World;
			FVector SpawnLocation;
			FRotator SpawnRotation;
			ANaveEnemiga* ReturnValue;
		};
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_NaveaFabricar;
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ATallerGeneral_FabricarNave_Statics::NewProp_NaveaFabricar = { "NaveaFabricar", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TallerGeneral_eventFabricarNave_Parms, NaveaFabricar), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATallerGeneral_FabricarNave_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATallerGeneral_FabricarNave_Statics::NewProp_NaveaFabricar,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATallerGeneral_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATallerGeneral_FabricarNave, "FabricarNave" }, // 2252894639
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATallerGeneral, 3936339256);
